...
def boy (color_hair, color_eyes, color_t_shirt, color_skin, color_border, color_mouth, color_pup, color_nose,
                  size, sc, x0, y0):
    angle_sh = 70
    angle_pl_sh = 40
...
LOR = (255, 215, 0)
screen.fill(WHT)
boy(PNK, GBL, ORG, SKN, BLC, RED, BLC, BRW, SIZE, screen, int(SIZE * 0.5), 0)
